...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $pdo->prepare("INSERT INTO msma_requests (user_id, nickname, play_time, source, skill) VALUES (?, ?, ?, ?, ?)");
...
<body>
    <div class="container">
        <h1>⚔️ Вы выбрали: Заявка на MineSurv: MSMAA</h1>
        
        <form method="POST">
            <div class="question">
                <span class="number">1️⃣</span>
            ...
            <div class="question">
                <span class="number">2️⃣</span>
                <span class="label">Сколько вы играете?</span>
                <input type="text" name="playTime" placeholder="Например: 3 года" required>
            </div>
            
            <div class="question">
                <span class="number">3️⃣</span>
                <span class="label">Откуда вы узнали о сервере?</span>
                <input type="text" name="source" placeholder="Например: Реклама, друг" required>
            </div>
            
            <div class="question">
                <span class="number">4️⃣</span>
            ...
            <div class="buttons">
                ...
                <button type="submit" class="btn btn-submit">⚔️ Отправить заявку MSMAA</button>
            </div>
        </form>
    </div>
</body>
